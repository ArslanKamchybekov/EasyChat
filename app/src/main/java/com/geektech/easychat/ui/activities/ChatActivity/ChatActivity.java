package com.geektech.easychat.ui.activities.ChatActivity;
...
import com.geektech.easychat.adapters.ChatAdapter;
import com.geektech.easychat.databinding.ActivityChatBinding;
import com.geektech.easychat.models.ChatMessage;
    ...
    private void listenAvailabilityOfReceiver() {
        database.collection(Constants.KEY_COLLECTION_USERS).document(
            ...
            if (isReceiverAvailable) {
                binding.textAvailability1.setVisibility(View.VISIBLE);
            } else {
                binding.textAvailability1.setVisibility(View.GONE);
            }
        });
    }
